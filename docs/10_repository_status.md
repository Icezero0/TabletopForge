...
数据库迁移：`20260604_0001_initial_schema.py`、`20260604_0002_add_room_member_game_role.py`、`20260604_0003_add_room_personal_memos.py`。
...
| 业务资源库（地图/Token 素材） | `09_module_design/asset_library.md`；当前仅底层 `image` / `audio` asset 已落地，地图/Token 语义层未落地 |
...
| 跑团桌面 MVP（`01` §4.2） | **进行中**（Step 1–3 已落地：身份、五区布局、治理/聊天迁入、备忘录 HTTP、场上角色空态；地图/角色业务待 Step 4–5） |
