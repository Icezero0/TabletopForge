export default {
  ...
  character: {
    ...
    spells: {
      ...
      autoCalcSpellSlots: "Auto-calc spell slots",
      cantrips: "Cantrips",
    ...
    resources: {
      ...
      resourceRecoveryPlaceholder: "e.g. Long rest, short rest",
      resourceNotes: "Notes",
      resourceNotesPlaceholder: "Optional notes",
      editResource: "Edit resource",
      removeResource: "Remove resource",
      unnamedResource: "Unnamed resource",
      recoveryLongRest: "Long rest",
      recoveryShortRest: "Short rest",
    ...
    import: {
      ...
      fileHint: "Choose a JSON character sheet exported by TabletopForge.",
      placeholder: "Paste character text here…",
      preview: "Parse & preview",
      aiImport: "AI import",
      fileImport: "File import",
      chooseFile: "Choose character file",
      apply: "Confirm",
      ...
      fileFailed: "File import failed. Make sure it was exported from a character sheet.",
  ...
  table: {
    ...
    music: {
      ...
      shuffle: "Shuffle",
      upload: "Upload audio",
      uploadHint: "Create library music and add it to the playlist",
      allowPlayerControl: "Allow PL to control background music",
      searchPlaceholder: "Search music",
      refreshLibrary: "Refresh library",
      playlist: "Playlist",
      library: "Library music",
      emptyPlaylist: "No tracks in playlist",
      emptyLibrary: "No music in library",
      loadFailed: "Failed to load music resources",
      saveFailed: "Failed to save background music",
    ...
    assets: {
      ...
      mapFromLibrary: "From library",
      mapDirectUpload: "Upload file",
      libraryPickerTitle: "Pick a map from library",
      libraryPickerEmpty: "No map backgrounds in your library",
      addMapFromLibrarySuccess: "Map added from library",
      addMapFromLibraryFailed: "Failed to add map",
      ...
      tokenConfigEmpty: "No token configs for this character",
