export default {
  ...
  character: {
    ...
    resources: {
      ...
      resourceNotes: "备注",
      resourceNotesPlaceholder: "可选备注",
      editResource: "编辑资源",
      removeResource: "删除资源",
      unnamedResource: "未命名资源",
      recoveryLongRest: "长休",
      recoveryShortRest: "短休",
    ...
    import: {
      ...
      fileHint: "选择由 TabletopForge 导出的 JSON 角色卡文件。",
      ...
      textRequired: "请先粘贴文本",
      fileFailed: "文件导入失败，请确认文件来自角色卡导出",
    ...
    export: {
      ...
      copied: "已复制到剪贴板",
      copyFailed: "复制失败",
      savingThrowProficiencies: "豁免熟练项",
  ...
  table: {
    ...
    music: {
      ...
      shuffle: "随机播放",
      upload: "上传音频",
      uploadHint: "创建资源库音乐并加入播放列表",
      allowPlayerControl: "允许 PL 操作背景音乐",
      searchPlaceholder: "搜索音乐",
      refreshLibrary: "刷新资源库",
      playlist: "播放列表",
      library: "资源库音乐",
      emptyPlaylist: "暂无播放曲目",
      emptyLibrary: "资源库中暂无音乐",
      loadFailed: "音乐资源加载失败",
      saveFailed: "背景音乐设置保存失败",
      uploadFailed: "音频上传失败",
    },
    measure: {
      toolbar: "测距工具",
