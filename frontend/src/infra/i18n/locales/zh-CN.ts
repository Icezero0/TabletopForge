export default {
  ...
  character: {
    ...
    errors: {
      loadFailed: "加载失败，请刷新重试",
      nameRequired: "请填写角色名",
      tokenNameRequired: "请为每个 Token 配置填写名称",
    },
  ...
  table: {
    ...
    menu: {
      ...
      layerSingleToken: "单个 Token 无需排序",
    ...
    characterList: {
      title: "角色列表",
      empty: "房间中还没有角色。",
      emptyOnField: "场上还没有角色 Token。",
      instanceLabel: "#{n}",
      owner: "归属",
      spawned: "角色 Token 已上场",
      spawnFailed: "上场失败",
      addCharacter: "添加角色",
      hidden: "隐藏",
      hideCharacter: "对玩家隐藏",
    ...
    inspector: {
      infoTitle: "信息",
      infoEmpty: "在 Token 菜单选择「查看信息」，或点击场上角色列表中的角色。",
      close: "关闭",
      loadFailed: "加载角色失败",
      abilities: "属性",
      savingThrows: "豁免",
    ...
    assets: {
      ...
      addMap: "添加地图",
      addCharacter: "添加角色",
      placeTokenTitle: "放置 Token",
      placeTokenHint: "输入名称（无图时显示首字），确认后在地图上点击放置。",
      tokenNameLabel: "名称",
      tokenNamePlaceholder: "角色或标记名称",
      tokenImageLabel: "Token 图片（可选）",
      placeTokenConfirm: "开始放置",
      placeTokenCancel: "取消",
      placeTokenActive: "点击地图放置 Token（Esc 取消）",
      placeTokenSuccess: "Token 已放置",
      placeTokenFailed: "Token 放置失败",
      nameRequired: "请输入名称",
