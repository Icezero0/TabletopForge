export default {
  ...
  character: {
    ...
    token: {
      primaryToken: "主要 Token",
      secondaryTokens: "次要 Token",
      noPrimary: "尚未设置主要 Token",
      addPrimary: "添加主要 Token",
      generateFromSheet: "从角色卡生成",
      defaultPrimaryName: "主要 Token",
      addSecondary: "添加次要 Token",
      noSecondary: "暂无次要 Token",
      primary: "主要",
      changeImage: "更换图片",
      namePlaceholder: "Token 名称",
      editPanel: "编辑面板",
      unnamed: "未命名 Token",
      panelEditor: "面板初始配置",
